        ...
        <div className="bg-gray-50">
            ...
            <div className="text-xl  flex border-b border-gray-100  p-2 md:w-10/12 mx-auto">
                <div className="flex items-center">
                    ...
                    <h1 className="font-semibold md:text-xl text-lg font-Inter">封面图</h1>
                </div>

                <a href="https://wwang.eu.org/" target="_blank" rel="noreferrer" className="hover:translate-x-2 duration-300 bg-gray-700 group rounded-xl md:px-4 text-white md:text-sm text-xs ml-auto mr-4 font-Inter font-semibold p-2">
            ...
            <div className="md:my-32  my-10 mx-auto">
                ...
                <div className="md:w-10/12 mx-auto flex flex-col ">
                    <div className="md:w-9/12 text-center mx-auto ">
                        <h2 className="text-5xl py-4 font-bold font-Anek text-gray-700">为什么封面图片比您想象的更重要？</h2>
                    ...
                    <div className="flex md:flex-row flex-col mx-auto justify-center my-10 mx-auto">
                        ...
                        <div className="m-10 p-10 bg-white rounded-xl shadow-xl shadow-gray-100 flex flex-col  md:w-4/12 ">
                            ...
                            <p className="text-2xl md:text-left text-center text-gray-700">每天发布大约 <span className="font-bold">700 万篇</span> 博文随着新时代博客工具的兴起，它只会上升.</p>
                        </div>
                        ...
                        <div className="m-10 p-10 bg-white rounded-xl shadow-xl shadow-gray-100 flex  flex-col  md:w-4/12 ">
                            ...
                            <p className="text-2xl md:text-left text-center text-gray-700">一张好的封面图片可以带来比随机库存图片<span className="font-bold">更高的转化率</span> .</p>
                        </div>
                ...
                <h2 className="md:text-5xl text-3xl md:w-1/2 mx-auto mt-32 font-bold font-Anek text-center text-gray-700">使用 coverview，您可以在<span className="text-indigo-400">几秒钟</span>内创建封面图像.</h2>
                ...
                <div className="md:w-8/12  flex md:flex-row flex-col justify-center items-center mx-auto">
                    ...
                    <div className="text-center md:w-1/3 m-4">
                        ...
                        <p className="text-xl">Unsplash 集成、用于个人品牌的自定义图标等.</p>
                    </div>
            ...
            <footer className="bg-white p-10 flex md:flex-row flex-col font-Inter md:px-20 justify-center items-center">
                <div className="md:w-1/2 flex flex-col">
                    <span className="text-lg">Made with 💛 by <a href="https://wwang.eu.org/" className="font-semibold" target="_blank" rel="noreferrer">时光 Blog</a></span>
